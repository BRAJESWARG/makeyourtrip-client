    ...
    return (
        <section className="HotelOverviewstyles__OuterWrapperDiv-sc-i4dhtt-2 kutOgb">
            <div className="HotelOverviewstyles__HotelOverviewContainer-sc-i4dhtt-0 bbgLaK">
                <div className="HotelOverviewstyles__HotelInfoImageContainer-sc-i4dhtt-1 jJjowe">
                    <section className="HotelDetailsMain__OuterWrapperDiv-sc-bcynzx-0 gxYrUi">
                        <section className="HotelDetailsMain__HotelDetailsContainer-sc-bcynzx-1 fyvULD">
                            <div className="HotelInfostyles__Wrapper-sc-138dfbx-5 geOkNK">
                                ...
                                <div className="HotelInfostyles__HotelNameAndAddressAndReviewWrapper-sc-138dfbx-3 kGIkTk">
                                    <div className="HotelInfostyles__HotelNameAndAddressContainer-sc-138dfbx-2 ijMqTd">
                                                ...
                                                <div className="HotelAddressText__HotelAddressTextDiv-sc-1lcrowf-2 cUDamO">
                                                    ...
                                                    <span className="HotelAddressText__PersuationAddressOuterSpan-sc-1lcrowf-7 YLmOj">
                                                        ...
                                                        <span className="HotelAddressText__PersuationAddress-sc-1lcrowf-6 pSgkl">
                                                            4.0 km drive to Indira Gandhi International Airport
                                                        </span>
                                                    </span>
                                                </div>
                                            </a>
                                                ...
                                                <div className="dwebCommonstyles__FlexItem-sc-112ty3f-4 gwpVPd">
                                                    <div className="ReviewInfostyles__RatingOuterWrapper-sc-extx54-17 bHFLpI">
                                                        <div className="ReviewInfostyles__ImageWrapper-sc-extx54-18 cjxKhb">
                                                            <div className="ReviewInfostyles__NewViewMap-sc-extx54-13 evERWw">
                                                                <img
                                                                    src="https://gos3.ibcdn.com/mapPin-1638795585.png"
                                                                    alt=''
                                                                    className="ReviewInfostyles__NewMapPin-sc-extx54-14 jqwsUI"
                                                                />
                                                            </div>
                                                    ...
                                                    <div className="ReviewInfostyles__ReviewOuterWrapper-sc-extx54-19 dtSHLP">
                                                        <div className="ReviewInfostyles__ReviewInnerWrapper-sc-extx54-20 iYaNAT">
                                                            <div style={{ bgcolor: '#1ca54f' }} className="ReviewInfostyles__RatingWrapper-sc-extx54-21 jWtJgd">
                                                                <span style={{ color: '#18A160' }} className="ReviewInfostyles__ReviewNumber-sc-extx54-3 hyxOAP">
                    ...
                    <div className="CaptivateGallerystyles__ImageGalleryWrapper-sc-1dvzj0j-0 iYvHLx">
                        <div className="CaptivateBannerGalleryWithVideostyles__CaptivateBannerGallery-sc-1sonew0-1 bxQlyx">
                            <div className="CaptivateBannerGalleryWithVideostyles__CaptivateMainImageWrapper-sc-1sonew0-2 jbqXwI">
                                <div className="Carouselstyles__CarouselContainer-sc-1hv3vvl-1 iAowDS">
                                    ...
                                    <div className="Carouselstyles__CarouselControls-sc-1hv3vvl-4 cmcZMx">
                                        ...
                                        <div className="CaptivateBannerGalleryWithVideostyles__IconWrapper-sc-1sonew0-29 neXif">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="28px" height="32px" fill="#FFFFFF" className="HappyAngleRightIconNew-sc-1chvzb2-0 eAMJYk">
                                                <g filter="url(#happyAngleRightIconNew_svg__a)">
                                                    <path fill="#fff" d="M24.798 20.62 11.619 31.492c-.977.818-2.386.628-3.147-.423-.76-1.052-.584-2.567.394-3.385l.025-.02 11.25-9.282a.505.505 0 0 0 0-.772L8.89 8.337c-.988-.804-1.184-2.316-.438-3.379.747-1.063 2.153-1.273 3.142-.47l.024.02L24.798 15.38c1.345 1.109 1.6 3.181.569 4.628q-.248.346-.57.612">
                                                    </path>
                                                </g>
                                                <defs>
                                                    <filter id="happyAngleRightIconNew_svg__a" width="34" height="44" x="0" y="0" color-interpolation-filters="sRGB" filterUnits="userSpaceOnUse">
                                                        ...
                                                        <feBlend in2="BackgroundImageFix" result="effect1_dropShadow_110_2204">
                                                        </feBlend>
                                                        <feBlend in="SourceGraphic" in2="effect1_dropShadow_110_2204" result="shape">
                                                        </feBlend>
                                                    </filter>
                                                </defs>
                                            </svg>
                                ...
                                <div className="CaptivateBannerGalleryWithVideostyles__ItemInfoWrapperLarge-sc-1sonew0-23 bRQsAw">
                                    <div className="CaptivateBannerGalleryWithVideostyles__InfoLeftSection-sc-1sonew0-24 ddxGUj">
                                        <p>
                                            <strong>Property Photos (161)</strong>
                                        </p>
                                    </div>
                                    <div className="CaptivateBannerGalleryWithVideostyles__InfoRightSection-sc-1sonew0-25 gxYoWL">
                                        View All
                                        <svg xmlns="http://www.w3.org/2000/svg" width="inherit" height="inherit" fill="none" viewBox="0 0 12 12" className="HappyLeftArrowTransparent-sc-wpmm06-0 fpLege">
                                            <path fill="inherit" fill-rule="evenodd" d="M6 12a6 6 0 0 1-6-6 6.007 6.007 0 0 1 6-6 6 6 0 1 1 0 12m3.104-6.354-2.25-2.25a.5.5 0 0 0-.708.707L7.33 5.287a.125.125 0 0 1-.089.213H3a.5.5 0 0 0 0 1h4.241a.125.125 0 0 1 .089.212L6.146 7.896a.5.5 0 0 0 .708.706l2.25-2.25a.5.5 0 0 0 0-.707" clip-rule="evenodd">
                                            </path>
                                        </svg>
                                    </div>
                                </div>
                            </div>
                            <div className="CaptivateBannerGalleryWithVideostyles__ImageRightSectionWrapper-sc-1sonew0-27 klgonA">
                                <div className="CaptivateBannerGalleryWithVideostyles__ImageItemWrapper-sc-1sonew0-28 goudSc">
                                    <img
                                        src="https://r1imghtlak.mmtcdn.com/f37c4a2c48b711ea98e40242ac110003.jpg"
                                        alt="Pride Plaza Hotel Aerocity New Delhi - Tap to explore photos"
                                    />
                                    <div className="CaptivateBannerGalleryWithVideostyles__ItemInfoWrapper-sc-1sonew0-22 gpECxs">
                                        <div className="CaptivateBannerGalleryWithVideostyles__InfoLeftSection-sc-1sonew0-24 ddxGUj">
                                            <p>
                                                <strong>Room(77)</strong>
                                            </p>
                                        </div>
                                        <div className="CaptivateBannerGalleryWithVideostyles__InfoRightSection-sc-1sonew0-25 gxYoWL">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="inherit" height="inherit" fill="none" viewBox="0 0 12 12" className="HappyLeftArrowTransparent-sc-wpmm06-0 fpLege">
                                ...
                                <div className="CaptivateBannerGalleryWithVideostyles__ImageItemWrapper-sc-1sonew0-28 goudSc">
                                    <img
                                        src="https://gi-ugcvideos.goibibo.com/s/delhi-prideplazahotelaerocitynewdelhi-wnv-169259590725188974-480-480-700K.jpg"
                                        alt="Pride Plaza Hotel Aerocity New Delhi - TravellerPhoto"
                                    />
                                    <div className="CaptivateBannerGalleryWithVideostyles__ItemInfoWrapper-sc-1sonew0-22 gpECxs">
                                        <div className="CaptivateBannerGalleryWithVideostyles__InfoLeftSection-sc-1sonew0-24 ddxGUj">
                                            <p>
                                                <strong>Traveller Photos(799)</strong>
                                            </p>
                                        </div>
                                        <div className="CaptivateBannerGalleryWithVideostyles__InfoRightSection-sc-1sonew0-25 gxYoWL">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="inherit" height="inherit" fill="none" viewBox="0 0 12 12" className="HappyLeftArrowTransparent-sc-wpmm06-0 fpLege">
                ...
                <section className="PriceNBookingButtonNPersuasionstyles__OuterWrapperDiv-sc-d7fkwd-26 cQAeFK">
                    <section className="PriceNBookingButtonNPersuasionstyles__Container-sc-d7fkwd-0 krDZDN">
                        <div style={{ width: '360px', marginTop: '4.5rem' }} className="PriceNBookingButtonNPersuasionstyles__UGCPersuasionsAndBookingWidget-sc-d7fkwd-1 bzCKco">
                            <section style={{ width: '360px' }} className="PriceNBookingButtonNPersuasionstyles__SignUpPersuasionEMIBookingWidgetContainer-sc-d7fkwd-2 ckHFW">
                                <div className="BookingWidgetstyles__BookingWidgetStyleContainer-sc-bwqud6-0 jirlwh">
                                    <p className="BookingWidgetstyles__PriceStartsAtText-sc-bwqud6-1 cFqHdv">Day use room (10 am to 4 pm) Maximum 6 hrs stay.</p>
                                    <div className="BookingWidgetstyles__PriceInfo-sc-bwqud6-2 jREzVX">
                                        ...
                                        <div className="BookingWidgetstyles__Column-sc-bwqud6-3 dFmDgp">
                                            <div className="dwebCommonstyles__FlexCentered-sc-112ty3f-6 lfQUri">
                                                ...
                                                <p className="BookingWidgetstyles__PriceValueStyled-sc-bwqud6-4 csEaWM">4,050</p>
                                            </div>
                                            <div className="dwebCommonstyles__FlexCentered-sc-112ty3f-6 lfQUri">
                                                +
                                                <p className="BookingWidgetstyles__PlusPriceValueText-sc-bwqud6-5 kBdKJl">486 taxes &amp; fees</p>
                                            </div>
                                    ...
                                    <span itemprop="priceRange" className="dwebCommonstyles__HiddenElement-sc-112ty3f-17 cJirRI">Pride Plaza Hotel Aerocity New Delhi Price Starts at INR 4,050/Night</span>
                                    <button className="dwebCommonstyles__ButtonBase-sc-112ty3f-14 BookingWidgetstyles__ViewRoomOptionsButton-sc-bwqud6-10 cYhrVX cjSXqJ">
                                        <div styleprops="[object Object]" className="TextFieldExpt__Tag-sc-7a7pro-0 hAWoHt">
                                            <span>VIEW 15 ROOM OPTIONS</span>
