                    ...
                    <MDBRow className='g-0'>
                        <MDBCol md='9' className=''>
                            <MDBRow className='g-0'>
                                <MDBCol md='7'>
                                    <div className=''>
                                        ...
                                        <a href="/#" width="100%" class="TriggerActionText__TriggerAnchorText-sc-1vbd2op-0 tzmmd">
                                ...
                                <MDBCol md='5'>
                                    <div class="HotelInfostyles__ReviewInfoContainer-sc-138dfbx-4 joohaA">
                                        <a href="/#" class="TriggerActionText__TriggerAnchorText-sc-1vbd2op-0 gnNNeO">
                                            <div class="ReviewInfostyles__FlexItemColumn-sc-extx54-16 cVXDiL">
                                                <div class="dwebCommonstyles__FlexItem-sc-112ty3f-4 gwpVPdB">
                                                    <div class="ReviewInfostyles__RatingOuterWrapper-sc-extx54-17 bHFLpI">
                                                        <div class="ReviewInfostyles__ImageWrapper-sc-extx54-18 cjxKhb">
                                                            <div class="ReviewInfostyles__NewViewMap-sc-extx54-13 evERWw">
                                                                <img src="https://gos3.ibcdn.com/mapPin-1638795585.png" alt='' class="ReviewInfostyles__NewMapPin-sc-extx54-14 jqwsUI" />
                                                            </div>
                                                            <div class="ReviewInfostyles__NewViewMapCTA-sc-extx54-15 iINLVi">View Map</div>
                                                        </div>
                                                    </div>
                                                    <div class="ReviewInfostyles__ReviewOuterWrapper-sc-extx54-19 dtSHLP">
                                                        <div class="ReviewInfostyles__ReviewInnerWrapper-sc-extx54-20 iYaNAT">
                                                            <div bgcolor="#48b41c" class="ReviewInfostyles__RatingWrapper-sc-extx54-21 kjYceN">
                                                                <span color="#1ABA32" class="ReviewInfostyles__ReviewNumber-sc-extx54-3 hyxOAP">
                                                                    <span itemprop="worstRating" content="1">
                                                                    </span>
                                                                    <span itemprop="ratingValue">3.9</span>
                                                                    <span>/</span>
                                                                    <span itemprop="bestRating" class="ReviewInfostyles__OutOfNumberForReview-sc-extx54-6 gnnIdA">5</span>
                                                                </span>
                                                            </div>
                                                            <div class="ReviewInfostyles__NewViewMapCTA-sc-extx54-15 iINLVi">View Reviews</div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <MDBRow className='g-0' >
                                ...
                                <MDBCol md='8'>
                                    <div class="CaptivateGallerystyles__ImageGalleryWrapper-sc-1dvzj0j-0 iYvHLx">
                                        <div class="CaptivateGallerystyles__AltAccoCaptivateBannerContainer-sc-1dvzj0j-1 bXQfQi">
                                            <div class="CaptivateBannerGallerystyles__CaptivateBannerGallery-sc-dn43rp-1 kNYAlG">
                                                <div class="CaptivateBannerGallerystyles__CaptivateBannerOuterContainer-sc-dn43rp-11 dJYjNs">
                                                    <div class="CaptivateBannerGallerystyles__WideImagePreviewWrap-sc-dn43rp-6 fJkWyA">
                                                        <div class="CaptivateBannerGallerystyles__CaptivateGalleryOverlayTabWrap-sc-dn43rp-13 dKjUdJ">
                                                            <div class="CaptivateBannerGallerystyles__CaptivateGalleryOverlayTab-sc-dn43rp-14 eLINGK">
                                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="#FFFFFF" margin="0 .5rem 0 0" class="HappyBuildingIcon-sc-sv2xip-0 pWtdx">
                                                            ...
                                                            <div class="CaptivateBannerGallerystyles__CaptivateGalleryOverlayTab-sc-dn43rp-14 eLINGK">
                                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="#FFFFFF" margin="0 .5rem 0 0" class="HappyGuestCameraIcon-sc-1rlytel-0 kMWgnD">
                                                    ...
                                                    <div marginbottom="1rem" class="CaptivateBannerGallerystyles__CaptivateBannerGalleryContainer-sc-dn43rp-0 dvXhdS">
                                                        <div class="Carouselstyles__CarouselContainer-sc-1hv3vvl-1 iAowDS">
                                                            <div class="Carouselstyles__CarouselSlider-sc-1hv3vvl-2 jUQFXK">
                                                                <div class="Carouselstyles__SliderWrap-sc-1hv3vvl-3 bRTEOS"
                                                                    style={{ transform: 'transform: translate3d(0px, 0px, 0px);' }}
                                                                >
                                                                    <div class="Carouselstyles__CarouselSlide-sc-1hv3vvl-5 ccUBwm">
                                                                        <img src="//r1imghtlak.ibcdn.com/7dea04d4810911ecb06d0a58a9feac02.jpg?&amp;output-quality=75&amp;downsize=520:350&amp;crop=520:350;0,85&amp;output-format=webp" alt="Main gallery" class="CaptivateBannerGallerystyles__CaptivateGalleryImage-sc-dn43rp-8 fYqGpU" data-testid="" itemprop="image" listitemwidth="100%" />
                                                                    </div>
                                                                    <div class="Carouselstyles__CarouselSlide-sc-1hv3vvl-5 ccUBwm">
                                                                        <img src="//r1imghtlak.ibcdn.com/f1a506e41bb511ecbd530a58a9feac02.jpg?&amp;output-quality=75&amp;downsize=520:350&amp;crop=520:350;0,85&amp;output-format=webp" alt="Main gallery" class="CaptivateBannerGallerystyles__CaptivateGalleryImage-sc-dn43rp-8 fYqGpU" data-testid="" listitemwidth="100%" />
                                                                    </div>
                                                                    <div class="Carouselstyles__CarouselSlide-sc-1hv3vvl-5 ccUBwm">
                                                                        <img src="https://gos3.ibcdn.com/default-4-1426763954.png" alt="Main gallery" class="CaptivateBannerGallerystyles__CaptivateGalleryImage-sc-dn43rp-8 fYqGpU" data-testid="" listitemwidth="100%" />
                                                                    </div>
                                                                    <div class="Carouselstyles__CarouselSlide-sc-1hv3vvl-5 ccUBwm">
                                                                        <img src="https://gos3.ibcdn.com/default-4-1426763954.png" alt="Main gallery" class="CaptivateBannerGallerystyles__CaptivateGalleryImage-sc-dn43rp-8 fYqGpU" data-testid="" listitemwidth="100%" />
                                                                    </div>
                                                                    ...
                                                                    <div class="Carouselstyles__CarouselSlide-sc-1hv3vvl-5 ccUBwm">
                                                                        <div class="dwebCommonstyles__CenteredDivWrap-sc-112ty3f-1 CaptivateBannerGallerystyles__WideImageViewAllPhotosOuter-sc-dn43rp-2 bGKfHf iBqcKR">
                                                                            <img src="https://gos3.ibcdn.com/default-4-1426763954.png" alt="" class="CaptivateBannerGallerystyles__CaptivateGalleryImage-sc-dn43rp-8 CaptivateBannerGallerystyles__CaptivateGalleryImageViewAll-sc-dn43rp-12 dozrMg kTHxxY" data-testid="" />
                                                                            <div class="dwebCommonstyles__CenteredDivWrap-sc-112ty3f-1 CaptivateBannerGallerystyles__WideImageViewAllPhotos-sc-dn43rp-3 bGKfHf gINffC">
                                                                                <h3 class="dwebCommonstyles__SectionHeader-sc-112ty3f-9 CaptivateBannerGallerystyles__ViewAllPhotosText-sc-dn43rp-5 gxmRLJ dgvubf">
                                                                                    <span>View All</span>
                                                                                </h3>
                                                                            </div>
                                                                        </div>
                                                            ...
                                                            <div class="Carouselstyles__CarouselControls-sc-1hv3vvl-4 cmcZMx">
                                                                <div class="dwebCommonstyles__CenteredDivWrap-sc-112ty3f-1 Carouselstyles__CarouselIconWrapper-sc-1hv3vvl-6 bGKfHf jivIUZ">
                                                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" fill="#FFFFFF" width="1.2rem" height="1.2rem" class="HappyAngleLeftIcon-sc-15mlbp-0 iZkvQN">
                                                                ...
                                                                <div class="dwebCommonstyles__CenteredDivWrap-sc-112ty3f-1 Carouselstyles__CarouselIconWrapper-sc-1hv3vvl-6 bGKfHf hREPeu">
                                                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" fill="#FFFFFF" width="1.2rem" height="1.2rem" class="HappyAngleRightIcon-sc-1vqys28-0 ghgJFj">
                                                                        <path d="M26 16a3.07 3.07 0 0 1-1.04 2.305L10.091 31.386a2.462 2.462 0 0 1-3.251-3.698l13.003-11.439a.334.334 0 0 0 0-.501L6.84 4.309A2.463 2.463 0 0 1 10.092.611l14.864 13.077a3.08 3.08 0 0 1 1.045 2.309z">
                                                                        </path>
                                                                    </svg>
                                                                </div>
                                ...
                                <MDBCol md='4'>
                                    <div class="UGCCardChipsstyles__UGCPersuasions-sc-1wjbdwi-0 fOsFHx">
                                        <div class="VillaDetailsCardstyles__VillaCardWrapper-sc-1de73i2-0 bIHrOU">
                                            <div class="VillaDetailsCardstyles__VillaHeaderWrapper-sc-1de73i2-1 dhebRJ">
                                                <span class="VillaDetailsCardstyles__VillaIconWrapper-sc-1de73i2-2 legDce">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="26" height="28" fill="none" class="HappyVillaIcon-sc-txepgq-0 hNgjWe">
                                                ...
                                                <h4 class="VillaDetailsCardstyles__VillaHeader-sc-1de73i2-3 kxXWlU">Room in a Homestay</h4>
                                            </div>
                                            <ul class="VillaDetailsCardstyles__VillaListWrapper-sc-1de73i2-5 hRzPvT">
                                                <li class="VillaDetailsCardstyles__VillaListItem-sc-1de73i2-6 gVzTww">
                                                    <p>Bedrooms</p>
                                                    <p class="VillaDetailsCardstyles__ItemLogoWrapper-sc-1de73i2-7 fHkHrn">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="15px" height="20px" fill="none" viewBox="0 0 15 20" class="HappyBedVillaIcon-sc-eyxcmc-0 dEtffJ">
                                                ...
                                                <li class="VillaDetailsCardstyles__VillaListItem-sc-1de73i2-6 gVzTww">
                                                    <p>Beds</p>
                                                    <p class="VillaDetailsCardstyles__ItemLogoWrapper-sc-1de73i2-7 fHkHrn">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="inherit" height="inherit" fill="none" viewBox="0 0 26 16" class="HappyBedsVillaIcon-sc-10c97l3-0 jClWSO">
                                                ...
                                                <li class="VillaDetailsCardstyles__VillaListItem-sc-1de73i2-6 gVzTww">
                                                    <p>Max Guests</p>
                                                    <p class="VillaDetailsCardstyles__ItemLogoWrapper-sc-1de73i2-7 fHkHrn">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="inherit" height="inherit" fill="none" viewBox="0 0 22 18" class="HappyTwoPeopleOutlined-sc-mcylqu-0 joagdu">
                                        ...
                                        <div class="UGCCardChipsstyles__UGCPersuasionsInnerWrap-sc-1wjbdwi-1 gZXduj">
                                            <div class="UGCChipsCardstyles__UGCCardContainer-sc-o2g5e1-0 DcPSx">
                                                <div class="UGCChipsCardstyles__UGCPersuasionHeadingContainer-sc-o2g5e1-1 irBYur">
                                                    <h3 class="UGCChipsCardstyles__Text_Heading_UGCPersuasion-sc-o2g5e1-2 jmXGx">Amenities &amp; Services</h3>
                                                </div>
                                                <div class="dwebCommonstyles__BaseColumnWrap-sc-112ty3f-2 civGJZ">
                                                    <ul class="UGCChipsCardstyles__AmenitiesList-sc-o2g5e1-5 csJKpm">
                                                        <li>
                                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" class="HouseKeepingIcon-sc-5ioupd-0 clmBJd">
                                                            ...
                                                            <span class="UGCChipsCardstyles__AmenitiesText-sc-o2g5e1-7 jftUfU">Caretaker</span>
                                                        </li>
                                                        <li>
                                                            <svg viewBox="0 0 16 16" class="RoundedCheckbox-sc-4skzta-0 bpsfFU">
                                                                <g fill="none" fill-rule="evenodd">
                                                                    <path d="M-4-4h24v24H-4z">
                                                                    </path>
                                                                    <path fill="#898B91" d="M7.68 0a7.68 7.68 0 1 1 0 15.36A7.68 7.68 0 0 1 7.68 0m4.335 3.922-6.233 6.702-2.454-2.26a.436.436 0 0 0-.622.021.45.45 0 0 0 .022.632l2.556 2.358c.295.28.76.26 1.039-.032l6.326-6.8a.45.45 0 0 0-.011-.632.436.436 0 0 0-.623.011">
                                                            ...
                                                            <span class="UGCChipsCardstyles__AmenitiesText-sc-o2g5e1-7 jftUfU">Housekeeping</span>
                                                        </li>
                                                        <li>
                                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 15" class="HappyWifiIcon-sc-9vspjr-0 xcwlX">
                                                            ...
                                                            <span class="UGCChipsCardstyles__AmenitiesText-sc-o2g5e1-7 jftUfU">Free Wi-Fi</span>
                                                        </li>
                                                    </ul>
                                                    <a href='/#' class="dwebCommonstyles__PrimaryLink-sc-112ty3f-11 UGCChipsCardstyles__ViewAllAmenities-sc-o2g5e1-12 bmajuy dpJilB">View all amenities</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
